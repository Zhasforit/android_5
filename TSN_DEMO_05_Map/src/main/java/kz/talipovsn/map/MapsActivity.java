...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.27038089387808, 76.97104465004072); // Начальный маркер
    static final LatLng marker1 = new LatLng(52.26570399228676, 76.96735914919864); // Маркер ПГУ
    static final LatLng marker2 = new LatLng(52.26401292716377, 76.95984423874266);// Маркер ИнЕУ
    static final LatLng marker3 = new LatLng(52.298741108128134, 76.95508070711301);// Маркер ППУ
    static final LatLng marker4 = new LatLng(52.27038089387808, 76.97104465004072);// Маркер дома
    static final LatLng marker5 = new LatLng(52.27035768182003, 76.96814663266741);// Маркер Гулливера
    static final LatLng marker6 = new LatLng(52.269522039507144, 76.97121913798058);// Маркер БИЛ
    static final LatLng marker7 = new LatLng(52.26826854650347, 76.96862457792906);// Маркер KFC
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title(getString(R.string.marker4_title)).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.house)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title(getString(R.string.marker5_title)).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.guliver)).alpha(ALPHA).
